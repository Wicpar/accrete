...
pub fn clearing_neightbourhood(planet_mass: &f64, planet_axis: &f64, stellar_mass: &f64) -> f64 {
    ...
    let k = 807.0;
    let orbit_clearing = (planet_mass_earth_mass / (stellar_mass.powf(5.0 / 2.0) * planet_axis.powf(9.0 / 8.0))) * k;
    float_to_precision(orbit_clearing)
}
...
pub fn float_to_precision(value: f64) -> f64 {
